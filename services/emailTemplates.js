...
[owa] .mj-column-per-25 { width:25% !important; max-width: 25%; }
  ...
  @media only screen and (max-width:480px) {
    ...
    <img alt="Baby Banner" height="auto" src="https://invitation-tracker.herokuapp.com/baby_shower_banner.png" style="max-width: 100%; border: 0; display: block; outline: none; text-decoration: none; height: auto; width: 100%;" width="600">
    ...
    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
          ...
          <tr>
            <td align="center" class="mobile-text-padding" style="font-size:0px;padding:20px 5px 0px 5px;word-break:break-word;">
    ...
    <div style="font-family:'Roboto', sans-serif;font-size:20px;font-weight:600;line-height:1;text-align:center;color:#004DD9;">
      Sunday, April 7th 2019 from 1:00pm to 4:00pm
          ...
          <tr>
            <td align="center" class="mobile-text-padding" style="font-size:0px;padding:5px 5px 0px 5px;word-break:break-word;">
    ...
    <div style="font-family:'Roboto', sans-serif;font-size:20px;font-weight:600;line-height:1;text-align:center;color:#004DD9;">
      647 Grand St
          ...
          <tr>
            <td align="center" class="mobile-text-padding" style="font-size:0px;padding:5px 5px 20px 5px;word-break:break-word;">
    ...
    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
          ...
          <tr>
            <td align="center" class="mobile-terms-text" style="font-size:0px;padding:0px 10px 0px 10px;word-break:break-word;">
              
    <div style="font-family:'Roboto', sans-serif;font-size:20px;font-weight:600;line-height:1;text-align:center;color:#004DD9;">
      Please Rsvp by pressing the buttons above
    </div>
    ...
    <div style="font-family:'Roboto', sans-serif;font-size:20px;font-weight:600;line-height:1;text-align:center;color:#004DD9;">
      or respond to Saida by March 24th @ 347-233-6910
    </div>
